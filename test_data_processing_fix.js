// 🔍 TESTE ESPECÍFICO PARA VERIFICAR CORREÇÃO DO PROCESSAMENTO DE DADOS
// Execute este script no console do navegador

console.log('🚀 TESTE ESPECÍFICO: Verificando correção do processamento de dados...');

// Simular a função processTrainingDataForChart corrigida
    ...
    if (dateObj.getDay() === 1) { // 1 = segunda-feira
      console.log('🔍 DEBUG - Processando segunda-feira:', {
        ...
        sessionData: session ? {
          ...
          [metricField]: session[metricField]
        } : null,
...
if (mondayData && mondayData.hasData) {
  console.log('\n🎉 SUCESSO: A correção do processamento de dados funcionou!');
