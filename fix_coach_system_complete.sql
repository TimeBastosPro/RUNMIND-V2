-- Script COMPLETO para resolver problemas do sistema de treinadores
...
-- 13. Criar view para relacionamentos ativos
...
-- 14. Habilitar RLS na view
ALTER VIEW active_athlete_coach_relationships ENABLE ROW LEVEL SECURITY;

-- 15. Criar política RLS para a view
...
SELECT 
  ...
  cmd
FROM pg_policies
WHERE tablename IN ('coaches', 'teams', 'athlete_coach_relationships', 'active_athlete_coach_relationships')
ORDER BY tablename, policyname;

-- 20. Teste final de acesso
SELECT 
